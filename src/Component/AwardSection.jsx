    ...
    <div className="py-10 lg:py-14 border-b border-gray-100 last:border-0 overflow-hidden">
      ...
      >
        ...
        >
          ...
          <h2 className="mb-2 text-2xl lg:text-3xl parisienne-font text-gray-900 leading-tight">
            {title}
          </h2>
          {subtitle && (
    ...
    <div className="max-w-7xl mx-auto py-6">
      <div className="text-center mb-12 max-w-2xl mx-auto px-4">
        ...
        <motion.p
          ...
          className="text-2xl lg:text-3xl parisienne-font text-gray-900 leading-tight"
        >

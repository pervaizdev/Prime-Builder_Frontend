    ...
    <section className="relative overflow-hidden py-24 ">
      <div className="container mx-auto px-6">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <motion.h2
            className="mt-6 text-4xl lg:text-5xl parisienne-font text-center text-black"
          ...
          >
            Experience a lifestyle of unmatched comfort and convenience with our
            carefully curated selection of premium amenities and world-class
            features.
          </motion.p>
        </div>
